...
plot1 <- ggplot(data=data_plot_Mean,aes(x=meth,y=result))+geom_boxplot()+geom_hline(yintercept = mean_theo,color = "red")+ylab("")+xlab("")+scale_x_discrete(labels=c("MNAR","SoftMAR","Mean","Del")) +theme(axis.title.x=element_text(size=16),axis.title.y=element_text(size=16),axis.text.x=element_text(size=16,angle=60),axis.text.y=element_text(size=16),title=element_text(hjust = 0.5,size=16)) + theme(legend.position='none')
plot2 <- ggplot(data=data_plot_Var,aes(x=meth,y=result))+geom_boxplot()+geom_hline(yintercept = CovTheo[j,j],color = "red")+ylab("")+xlab("")+scale_x_discrete(labels=c("MNAR","SoftMAR","Mean","Del")) +theme(axis.title.x=element_text(size=16),axis.title.y=element_text(size=16),axis.text.x=element_text(size=16,angle=60),axis.text.y=element_text(size=16),title=element_text(hjust = 0.5,size=16)) + theme(legend.position='none')
